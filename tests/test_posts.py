...
@pytest.mark.anyio
async def test_get_posts_empty(client: AsyncClient): # Pytest injects the client fixture from conftest here
...
@pytest.mark.anyio
async def test_get_posts_not_found(client: AsyncClient): # Pytest injects the client fixture from conftest here
