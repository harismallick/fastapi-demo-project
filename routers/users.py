...
# imports for image upload and processing
...
# Import for S3 bucket integration
from botocore.exceptions import ClientError
from image_utils import upload_profile_image

router = APIRouter()

# "/api/users" will be the base route declared in main.py
# All routes written here will be relative to the base
...
async def reset_password(
    ...
    if reset_token.expires_at < datetime.now(UTC): # Version for postgres
